...
const CHANNELS = [
  ...
  { id: 'linkedin_ads', name: 'LinkedIn Ads', audience: 'المهندسون والمكاتب والشركات والمطورون وصناع القرار المهنيون', how: 'بناء حملة LinkedIn Ads ومجموعات جمهور وإعلانات وميزانية واختبارات، مع إبقاء الإطلاق والإنفاق معتمدين إلى أن يتوفر Advertising API وحساب إعلاني مصرح له.' },
...
export function buildChannelPlans(snapshot, insights = buildMarketingInsights(snapshot)) {
  ...
  const plans = [
    ...
    { channel: 'linkedin_ads', priority: 'متوسطة', audience: 'المهندسون والمكاتب والشركات والمطورون وصناع القرار في السوق السعودي', objective: 'اختبار اكتساب مدفوع عبر LinkedIn مع قياس التسجيلات والمشاريع المؤهلة.', message_angle: 'رسالة مهنية واحدة لكل شريحة مع صفحة هبوط واضحة داخل Bytly.', offer_cta: 'اكتشف Bytly / أنشئ حسابك', budget_suggestion: 'اختبار محدود بسقف إنفاق وموافقة يدوية قبل أي إطلاق.', kpi: 'Impressions → CTR → CPC → التسجيل المكتمل → المشروع المؤهل', cadence: 'اختبار 7–14 يومًا ثم قرار مبني على البيانات', expected_outcome: 'تحديد الشرائح والرسائل الإعلانية التي تستحق التوسع على LinkedIn.', evidence: 'التكامل الحالي يتيح نشر منشورات LinkedIn؛ إطلاق LinkedIn Ads يحتاج صلاحيات Advertising API وحسابًا إعلانيًا مصرحًا.', score: 1 },
  ];
