export const translations = {
  ar: {
    nav: {
      ...
      designMarketplace: "متجر التصاميم",
      login: "تسجيل الدخول",
      joinBytly: "انضم لـ بيتلي",
    ...
    home: {
      hero: {
        ...
        subtitle: "سواء كنت صاحب منزل، مستثمر عقاري، أو مهندس محترف، بيتلي تجمع بينك وبين أفضل الكفاءات الهندسية في بيئة رقمية متكاملة، تضمن حقوقك، وتسهل إدارة مشروعك من الفكرة إلى التنفيذ.",
    ...
    wallet: {
      ...
      subtitle: "إدارة رصيدك ومعاملاتك المالية",
      userTypes: {
        engineer: "مهندس",
        firm: "شركة استشارية"
      },
      rechargeWallet: "شحن المحفظة",
      noProfile: "يرجى إكمال ملفك الشخصي للوصول إلى المحفظة",
      tabs: {
    ...
    createProject: {
      directHire: "طلب خدمة مباشرة",
      newProject: "إضافة مشروع جديد",
      directHireDesc: "أرسل طلبك مباشرة للمهندس المختار",
      newProjectDesc: "أضف تفاصيل مشروعك للحصول على عروض من المهندسين",
      directHireFrom: "طلب خدمة مباشرة من:",
      privateService: "خدمة خاصة",
      pleaseRegister: "يرجى إكمال تسجيل حساب صاحب مشروع أولاً",
      totalPercentageError: "يجب أن يكون مجموع نسب المراحل 100%",
      directHireSuccess: "تم إرسال طلب الخدمة المباشرة بنجاح!",
      projectCreated: "تم إنشاء المشروع بنجاح!",
      projectType: {
        label: "نوع المشروع *",
        fullConstruction: "مشروع بناء كامل",
        fullConstructionDesc: "6 مراحل + مراجعة استشارية",
        fullConstructionFeatures: {
          structural: "تصميم إنشائي كامل",
          firmApproval: "موافقة الشركة الهندسية",
          securePay: "دفع محجوز بأمان"
        },
        expressService: "خدمة سريعة",
        expressServiceDesc: "مرحلتين فقط (50% + 50%)",
        expressServiceFeatures: {
          facades: "تصميم واجهات / ديكور",
          drawings: "رسومات تنفيذية 2D",
          fastDelivery: "تسليم سريع"
        },
        fullConstructionNote: "💡 المشاريع الكاملة تتطلب موافقة شركة هندسية استشارية قبل تحرير الدفعات"
      },
      fields: {
        title: "عنوان المشروع *",
        titlePlaceholder: "مثال: تصميم شقة سكنية 150 متر",
        description: "وصف المشروع *",
        descriptionPlaceholder: "اشرح تفاصيل مشروعك ومتطلباتك...",
        category: "تصنيف المشروع *",
        categoryPlaceholder: "اختر التصنيف",
        budgetFrom: "الميزانية من (ر.س)",
        budgetTo: "الميزانية إلى (ر.س)",
        location: "موقع المشروع",
        locationPlaceholder: "مثال: الرياض، حي النخيل",
        deadline: "الموعد النهائي المتوقع",
        attachments: "المرفقات (صور، مخططات، ملفات)",
        attachmentsHint: "اضغط لرفع الملفات",
        acceptedFormats: "صور، PDF، DWG"
      },
      milestones: {
        sixStages: "المراحل الستة (تلقائياً)",
        autoGenerated: "✓ سيتم إنشاء المراحل تلقائياً عند نشر المشروع",
        optional: "تحديد مراحل المشروع (اختياري)",
        defaultStages: "افتراضياً: مرحلتين (50% + 50%)",
        useDefault: "أو استخدم المرحلتين الافتراضيتين (50% + 50%)",
        addMilestones: "إضافة مراحل",
        hideMilestones: "إخفاء المراحل",
        stageNumber: "المرحلة {number}",
        stageTitle: "عنوان المرحلة",
        stageDesc: "وصف المرحلة والمخرجات المطلوبة",
        percentage: "النسبة من المبلغ %",
        durationDays: "المدة بالأيام",
        addNewStage: "+ إضافة مرحلة جديدة",
        totalPercentage: "إجمالي النسب: {total}%",
        mustBe100: "(يجب أن يساوي 100%)",
        stages: {
          contract: "توقيع العقد",
          architectural: "المخطط المعماري",
          development: "تطوير التصميم",
          permit: "رخصة البناء (بلدي)",
          executive: "المخططات التنفيذية",
  ...
  en: {
    nav: {
      ...
      projects: "Projects",
      gallery: "Gallery",
      designMarketplace: "Design Store",
      login: "Login",
      joinBytly: "Join Bytly",
      dashboard: "Dashboard",
      wallet: "Wallet",
      messages: "Messages",
    ...
    home: {
      hero: {
        ...
        subtitle: "Whether you're a homeowner, real estate investor, or professional engineer, Bytly connects you with the best engineering talent in an integrated digital environment that safeguards your rights and streamlines your project management from concept to execution.",
