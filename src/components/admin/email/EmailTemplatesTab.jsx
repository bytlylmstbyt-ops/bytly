...
export default function EmailTemplatesTab({ onRefresh }) {
  ...
  const readyTemplates = [
    ...
    { name:"ترحيب بحركة جديدة — بيتلي", subject:"مرحباً بك في بيتلي", category:"welcome", body:brandedBody("مرحباً بك في بيتلي","نرحب بانضمامك إلى منظومة بيتلي. نتطلع إلى أن تكون تجربتك معنا مهنية وسلسة، وأن تجد في المنصة الأدوات والخدمات التي تساعدك على إنجاز أعمالك بكفاءة."), variables:["name"]},
    { name:"ترحيب مقاول جديد — بيتلي", subject:"مرحباً بك كمقاول في بيتلي", category:"welcome", body:brandedBody("مرحباً بك في منظومة بيتلي","سعداء بانضمامك كمقاول إلى بيتلي. نتطلع إلى ربط خبراتك بالمشاريع المناسبة، وتسهيل تواصلك مع العملاء والمهندسين ضمن بيئة مهنية موثوقة.","الدخول إلى حسابي"), variables:["name"]},
    { name:"ترحيب مستشار جديد — بيتلي", subject:"مرحباً بك كمستشار في بيتلي", category:"welcome", body:brandedBody("مرحباً بك في منظومة بيتلي","يسعدنا انضمامك كمستشار إلى بيتلي. يمكنك من خلال المنصة تقديم خبرتك وخدماتك والوصول إلى الفرص والمشاريع التي تتناسب مع تخصصك.","الدخول إلى حسابي"), variables:["name"]},
    { name:"ترحيب بشركة استشارية — بيتلي", subject:"مرحباً بشركتكم في بيتلي", category:"welcome", body:brandedBody("مرحباً بكم في منظومة بيتلي","يسعدنا انضمام شركتكم الاستشارية إلى بيتلي. نهدف إلى توفير بيئة احترافية تساعدكم على عرض خدماتكم، إدارة الفرص، والتعاون مع العملاء والجهات الهندسية.","الدخول إلى حساب الشركة"), variables:["company_name","name"]},
    { name:"ترحيب مورد جديد — بيتلي", subject:"مرحباً بك كمورد في بيتلي", category:"welcome", body:brandedBody("مرحباً بك في منظومة بيتلي","نرحب بانضمامك كمورد إلى بيتلي. نتطلع إلى أن تكون المنصة قناة فعالة لعرض منتجاتك وخدماتك والوصول إلى احتياجات المشاريع المناسبة.","الدخول إلى حسابي"), variables:["name"]},
    { name:"ترحيب مهندس مساح — بيتلي", subject:"مرحباً بك كمهندس مساح في بيتلي", category:"welcome", body:brandedBody("مرحباً بك في منظومة بيتلي الهندسية","سعداء بانضمامك كمهندس مساح إلى بيتلي. يمكنك عرض تخصصك وخدماتك والمشاركة في المشاريع التي تحتاج إلى أعمال المسح والرفع الميداني.","الدخول إلى حسابي"), variables:["name"]},
    { name:"ترحيب مستشار قانوني — بيتلي", subject:"مرحباً بك كمستشار قانوني في بيتلي", category:"welcome", body:brandedBody("مرحباً بك في منظومة بيتلي","يسعدنا انضمامك كمستشار قانوني إلى بيتلي. نرحب بخبرتك ونتطلع إلى إتاحة فرص مهنية مناسبة لخدماتك القانونية المرتبطة بالمشاريع والأعمال.","الدخول إلى حسابي"), variables:["name"]},
