...
export default function FirmWelcomeSlides({ onComplete, onSkip }) {
  ...
  const slides = [
    {
      ...
      title: "إدارة متقدمة للمشاريع",
      description: "لوحة تحكم شاملة لإدارة جميع مشاريعك، فريقك، والمراجعات الفنية. تتبع التقدم، وثّق الاعتمادات، وأدِر المهام بكفاءة عالية.",
      stats: "توفير 70% من وقت الإدارة",
      image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800",
      features: ["إدارة فرق متعددة", "تتبع المشاريع الحية", "تقارير تفصيلية"]
    },
    {
      icon: ClipboardCheck,
      color: "from-purple-600 to-indigo-600",
      title: "مسار التدقيق الفني (Track A)",
      description: "خدمات المراجعة والاعتماد الفني للمشاريع الإنشائية. راجع المطابقة مع كود البناء السعودي (SBC)، اختم المخططات، واعتمد التراخيص بشكل احترافي.",
      stats: "أسرع عملية اعتماد في المملكة",
      image: "https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=800",
      features: ["مراجعة SBC", "اعتماد بلدي", "ختم احترافي"]
    },
    {
      icon: TrendingUp,
      color: "from-emerald-600 to-teal-600",
      title: "توسع أعمالك واستقطاب العملاء",
      description: "عزز حضورك في السوق، استقبل طلبات مشاريع جديدة، وقدّم خدمات استشارية متميزة. نحن نربطك بالعملاء المناسبين.",
      stats: "1500+ مشروع نشط شهرياً",
      image: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800",
      features: ["ملف شركة احترافي", "عملاء موثوقين", "دفع آمن مضمون"]
    }
  ];
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-slate-900/95 to-indigo-900/95 backdrop-blur-md z-50 flex items-center justify-center p-4" dir="rtl">
      <motion.div
