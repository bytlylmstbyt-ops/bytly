      ...
      <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col lg:flex-row gap-6" style={{ height: "calc(100vh - 65px)" }}>
        ...
        <div className="flex-1 min-h-0">
          <AIChat
            ...
            placeholder="صف الغرفة أو المنزل الذي تريد تجديده، أو ارفع صورة..."
            allowImages={true}
            initialMessage={`مرحباً! أنا مساعد التجديد الذكي من Bytly AI 🔧

أستطيع مساعدتك في:
• تحليل صور الغرف الحالية وتقديم اقتراحات تجديد
• اقتراح تحسينات بأقل تكلفة
• تصور قبل وبعد التجديد
• تقدير تكلفة التجديد

**ارفع صورة غرفتك** أو صفها لي وسأقدم لك خطة تجديد متكاملة!`}
          />
        </div>
      </div>
    </div>
