...
export default function RegisterSupplier() {
  ...
  const handleLogoUpload = async (e) => {
    ...
    try {
      const file_url = await uploadScopedFile("registration/suppliers", file);
  ...
  const toggleCategory = (cat) => {
    if (formData.product_categories.includes(cat)) {
      setFormData({
        ...formData,
      ...
      setFormData({
        ...formData,
        product_categories: [...formData.product_categories, cat]
      });
    }
  };
      ...
      <div className="max-w-4xl mx-auto px-4">
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center space-y-2 pb-8">
            ...
            <CardTitle className="text-3xl">تسجيل مورد جديد</CardTitle>
            <p className="text-slate-600">انضم إلى شبكة الموردين المعتمدين في بيتلي</p>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-slate-900 pb-2 border-b">معلومات المورد / الشركة</h3>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="مثال: شركة المواد الحديثة"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="مثال: مواد بناء وخرسانة"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-3 mt-2">
                      <button
                        type="button"
                        onClick={() => setFormData({ ...formData, supplier_type: "company" })}
                      ...
                      <button
                        type="button"
                        onClick={() => setFormData({ ...formData, supplier_type: "individual" })}
                        className={`flex-1 p-3 rounded-lg border text-sm transition-all ${
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="اكتب نبذة عن خبرتك ومنتجاتك..."
                    rows={4}
                  />
                </div>
              </div>
              ...
              <div className="space-y-3">
                <Label>فئات المنتجات / الخدمات</Label>
              ...
              <div>
                <Label>مستندات إضافية (كتالوجات، شهادات، إلخ)</Label>
                <div className="mt-2">
                  <label className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed rounded-lg cursor-pointer hover:bg-slate-50">
                    <div className="flex flex-col items-center">
                      {uploadingDocs ? (
